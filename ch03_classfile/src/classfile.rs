...
impl ClassFile {
    pub fn parse(class_data: Vec<u8>) -> Result<ClassFile, String> {
        let class_reader = ClassReader::new(class_data);
    ...
    pub fn read(&mut self, reader: &mut ClassReader) -> Result<(), String> {
    ...
    fn read_and_check_magic(&self, reader: &mut ClassReader) -> Result<(), String> {
    ...
    fn read_and_check_version(&self, reader: &mut ClassReader) -> Result<(), String> {
